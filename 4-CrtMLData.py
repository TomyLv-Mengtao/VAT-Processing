...
# Pos path
process_files("/workspaces/VAT-Processing/Duration_Slices/60/Pos", "/workspaces/VAT-Processing/ML/Pos/60")
# Neg path
process_files("/workspaces/VAT-Processing/Duration_Slices/60/Neg", "/workspaces/VAT-Processing/ML/Neg/60")
